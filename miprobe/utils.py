...
Main features
-------------
- Retrieve peptide **embeddings** by MiProbe accession id (e.g. `ORF050.00000001`).
...
def get_numpy_dataset(ids: List[str], embedding_model: str = "prott5") -> np.ndarray:
...
def get_transformer_input(ids: List[str], embedding_model: str = "prott5") -> torch.Tensor:
